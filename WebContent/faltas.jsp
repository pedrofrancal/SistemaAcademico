...
<body class="pattern">
	<div class="container gray vertical-center">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 my-4">
					<form action="verificarFaltas" method="post">
						<select name="materias" id="materias">
							...
							<option value="4203-011">Métodos Para a Produção do
								Conhecimento</option>
						</select> <input type="date" name="data" id="data"> <input
							type="submit" name="enviar" id="enviar" value="Mostrar">
					</form>
				</div>
			</div>
			...
			<br> <br>
			<div class="container-fluid">
				<form action="inserirFalta" method="post">

					<center>Data Escolhida: ${data}</center>

					<table class="table table-striped" border=2>
						<c:set var="cont" value="1" scope="page">
						</c:set>
